...
define(["dojo", "dojo/_base/declare","ebg/core/gamegui",], (dojo, declare) => {
  return declare("customgame.game", ebg.core.gamegui, {
    ...
    setup(gamedatas) {
      ...
      */
     addPrimaryActionButton(id, text, callback, container = "customActions"){
       if(!$(id))
        this.addActionButton(id, text, callback, container, false, 'blue');
     },

     addSecondaryActionButton(id, text, callback, container = "customActions"){
       if(!$(id))
        this.addActionButton(id, text, callback, container, false, 'gray');
     },

     addDangerActionButton(id, text, callback, container = "customActions"){
       if(!$(id))
        this.addActionButton(id, text, callback, container, false, 'red');
     },
